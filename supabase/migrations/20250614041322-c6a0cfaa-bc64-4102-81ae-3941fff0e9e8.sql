...
('melhores-mundo', '⭐ E se você pudesse contar com os melhores?', 'Imagine ter um copiloto estratégico formado pelos maiores especialistas em: Hormozi (ofertas), Halbert (copy), Brunson (funis), Collier (persuasão), Bencivenga (páginas), Todd Brown (VSLs)… Todos pensando e executando com você, 24h por dia. 👉 Isso faria diferença no seu negócio?', 'radio', '["Sim, com certeza", "Talvez, me conta mais", "Não agora"]', NULL),
('como-seria', '🔧 Como seria esse processo com o CopyHack™?', 'Agora imagine isso: Você entra em um sistema guiado, onde cada etapa do seu negócio — oferta, copy, página, tráfego e funil — é criada passo a passo ao seu lado. Com ferramentas de IA e estratégias validadas por nomes como Hormozi, Brunson, Halbert e Bencivenga. Tudo validado por um simulador financeiro e um roadmap visual — como se você tivesse um coprodutor experiente te guiando em cada decisão.', 'info', NULL, NULL),
